...
<xsl:template match="cv" disable-output-escaping="yes" >
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <xsl:comment><![CDATA[[if lt IE 8]>
        <link id="style" rel="stylesheet" type="text/css" media="screen" href="css/ie.css"/>
    <![endif]]]></xsl:comment>
    <xsl:comment><![CDATA[[if gte IE 8]>
        <link id="style" rel="stylesheet" type="text/css" media="screen" href="css/style.css"/>
    <![endif]]]></xsl:comment>
    <xsl:comment>
    <![CDATA[[if !IE]> ]]></xsl:comment>
    <link id="style" rel="stylesheet" type="text/css" media="screen and (min-device-width: 1024px) " href="css/style.css"/>
    ...
    <style media="print">
        .bgcolored{color:#<xsl:apply-templates select="color"/>;}
    </style>
    <style media="screen">
